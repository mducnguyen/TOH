System.register(['angular2/core', "./../httptest/hero-list.component", "angular2/http", "./hero.service", 'a2-in-memory-web-api/core', '../httptest/hero-data'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, hero_list_component_1, http_1, hero_service_1, core_2, http_2, core_3, hero_data_1;
    var TohComponent;
    return {
        setters:[
            function (core_1_1) {
                ...
                TohComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [
                            ...
                            core_2.provide(core_3.SEED_DATA, { useClass: hero_data_1.HeroData })
                        ]
                    }), 
