 ...
 */
System.register(['angular2/core', 'angular2/http', "./wikipedia.service", 'rxjs/Subject'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, wikipedia_service_1, Subject_1;
    var WikiComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            WikiComponent = (function () {
                function WikiComponent(_wikipediaService) {
                    ...
                    this.items = this._searchTermStream.debounceTime(300).distinctUntilChanged().switchMap(function (term) { return _this._wikipediaService.search(term); });
                }
